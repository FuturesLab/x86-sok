...
void MCAssembler::layout(MCAsmLayout &Layout) {
  ...
  for (MCSection &Sec : *this) {
    ...
    for (MCFragment &Frag : Sec) {
      ...
      // nobin change to MCContext and chnage MOFI to Ctx
      if (Ctx->getObjectFileType() == llvm::MCContext::IsELF && \
...
// nobin made void to std::string MCAssembler::WriteRandInfo
